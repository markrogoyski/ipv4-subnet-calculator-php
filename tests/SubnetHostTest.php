...
class SubnetHostTest extends \PHPUnit\Framework\TestCase
{
    /** @var Subnet */
    private $sub;
    ...
    /**
     * hostRange returns the correct range of addressable hosts
    ...
    public function testGetAddressableHostRange(string $ip_address, int $network_size, string $expected_minHost, string $expected_maxHost): void
    {
        ...
        // When
        $minHost = $sub->minHost()->asQuads();
        $maxHost = $sub->maxHost()->asQuads();
    ...
    /**
     * getMinHost returns the lower addressable host
     * @param        string $ip_address
     * @param        int    $network_size
     * @param        string $expected_minHost
     */
    ...
    /**
     * getMaxHost returns the upper addressable host
     * @param        string $ip_address
     * @param        int    $network_size
     * @param        string $_
     * @param        string $expected_maxHost
     ...
     */
    public static function dataProviderForAddressableHostRange(): array
    {
        return [
    ...
    /**
     * getMinHostQuads returns an array of quads
     * @param string $ip_address
     * @param int    $network_size
     ...
     * @return array[]
     */
    public static function dataProviderForGetMinHostQuads(): array
    {
        return [
    ...
    /**
     * getMaxHostQuads returns an array of quads
     * @param string $ip_address
     * @param int    $network_size
     * @param int[]  $expected_quads
     */
     ...
     * @return array[]
     */
    public static function dataProviderForGetMaxHostQuads(): array
    {
        return [
    ...
    /**
     * getMinHostHex returns a string of hex
     * @param string $ip_address
     * @param int    $network_size
     ...
     * @return array[]
     */
    public static function dataProviderForGetMinHostHex(): array
    {
        return [
    ...
    /**
     * getMaxHostHex returns a string of hex
     * @param string $ip_address
     * @param int    $network_size
     * @param string $expected_hex
     */
     ...
     * @return array[]
     */
    public static function dataProviderForGetMaxHostHex(): array
    {
        return [
    ...
    /**
     * getMinHostBinary returns a string of binary
     * @param string $ip_address
     * @param int    $network_size
     ...
     * @return array[]
     */
    public static function dataProviderForGetMinHostBinary(): array
    {
        return [
    ...
    /**
     * getMaxHostBinary returns a string of binary
     * @param string $ip_address
     * @param int    $network_size
     * @param string $expected_binary
     */
     ...
     * @return array[]
     */
    public static function dataProviderForGetMaxHostBinary(): array
    {
        return [
    ...
    /**
     * getMinHostInteger returns an integer
     * @param string $ip_address
     * @param int    $network_size
     ...
     * @return array[]
     */
    public static function dataProviderForGetMinHostInteger(): array
    {
        return [
    ...
    /**
     * getMaxHostInteger returns an integer
     * @param string $ip_address
     * @param int    $network_size
     * @param int    $expected_integer
     */
     ...
     * @return array[]
     */
    public static function dataProviderForGetMaxHostInteger(): array
    {
        return [
    ...
    public function testGetHostPortion(string $ip_address, int $network_size, string $host, array $quads, string $hex, string $binary, int $integer): void
    {
        ...
        // Then
        $this->assertSame($host, $sub->hostPortion()->asQuads());
        $this->assertSame($quads, $sub->hostPortion()->asArray());
        $this->assertSame($hex, $sub->hostPortion()->asHex());
        $this->assertSame($binary, $sub->hostPortion()->asBinary());
        $this->assertSame($integer, $sub->hostPortion()->asInteger());
    }

    /**
     * @return array[] [ip_address, network_size, host, quads, hex, binary]
     */
    public static function dataProviderForHostPortion(): array
    {
        return [

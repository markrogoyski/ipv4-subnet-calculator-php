 ...
 */
class SubnetCalculatorUtilizationTest extends TestCase
{
    /* ******************************* *
    ...
    public function testGetUsableHostPercentage(
        ...
        // Given
        $subnet = new SubnetCalculator($ip, $networkSize);

        // When
        $percentage = $subnet->getUsableHostPercentage();

        // Then
        $this->assertEqualsWithDelta($expectedPercentage, $percentage, 0.01);
    }

    public function dataProviderForUsableHostPercentage(): array
    {
        return [
    ...
    public function testGetUnusableAddressCount(
        ...
        // When
        $unusable = $subnet->getUnusableAddressCount();

        // Then
        $this->assertSame($expectedUnusable, $unusable);
    }

    public function dataProviderForUnusableAddressCount(): array
    {
        return [
    ...
    public function dataProviderForUtilizationForHosts(): array
    {
        return [
    ...
    public function dataProviderForWastedAddresses(): array
    {
        return [
    ...
    {
        // Given
        $subnet = new SubnetCalculator('192.168.1.0', 24);

        // When
        $utilization = $subnet->getUtilizationForHosts(0);
    ...
    public function testGetUtilizationForHostsRejectsNegativeValue(): void
    {
        ...
        // When
        $subnet->getUtilizationForHosts(-1);
    }
    ...
    public function testGetWastedAddressesWithZeroHosts(): void
    {
        ...
        // When
        $wasted = $subnet->getWastedAddresses(0);
    ...
    public function testUtilizationConsistencyWithHostCount(): void
    {
        ...
        // When
        $utilization = $subnet->getUtilizationForHosts($usableHosts);

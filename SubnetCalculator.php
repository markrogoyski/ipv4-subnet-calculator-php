...
class SubnetCalculator {
    ...
    public function getIPAddressRange() {
        return array( $this->getNetworkPortion(), $this->getBroadcastAddress() ); 
    }
    ...
    private function ipAddressCalculation( $format, $separator = '' ) {
        return implode( $separator, array_map( function($x) use ($format) { return sprintf( $format, $x ); }, $this->quads ) );
    }

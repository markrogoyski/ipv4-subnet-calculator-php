 ...
 */
class SubnetCalculatorOverlapTest extends \PHPUnit\Framework\TestCase
{
    /**
     * @test         overlaps returns true when subnets share any IP addresses
    ...
    {
        // Given
        $subnetA = SubnetCalculatorFactory::fromCidr($subnetA);
        $subnetB = SubnetCalculatorFactory::fromCidr($subnetB);
    ...
    /**
     * @test overlaps is symmetric (A overlaps B == B overlaps A)
     * @dataProvider dataProviderForOverlaps
     ...
     */
    public function dataProviderForOverlaps(): array
    {
        return [
            // B is subset of A
    ...
    /**
     * @test         contains returns true when this subnet fully contains another
    ...
    /**
     * @test         isContainedIn returns true when this subnet is fully contained in another
     ...
     */
    public function dataProviderForIsContainedIn(): array
    {
        return [
    ...
    /**
     * @test isContainedIn is the inverse of contains
     ...
     */
    public function dataProviderForContainsAndIsContainedInRelationship(): array
    {
        return [
    ...
    /**
     * @test If two subnets overlap but neither contains the other, both overlap checks are true but contains checks are false
     */
    public function testOverlapWithoutContainment(): void
    {
        ...
        $larger  = SubnetCalculatorFactory::fromCidr('192.168.1.0/24');
        $smaller = SubnetCalculatorFactory::fromCidr('192.168.1.0/25');
